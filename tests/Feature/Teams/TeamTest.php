...
class TeamTest extends TestCase
{
    ...
    #[Test]
    public function the_teams_index_page_can_be_rendered(): void
    {
    ...
    #[Test]
    public function team_slug_uses_next_available_suffix(): void
    {
        $user = User::factory()->create();
    ...
    #[Test]
    public function the_team_edit_page_can_be_rendered(): void
    {
        $user = User::factory()->create();
    ...
    #[Test]
    public function teams_can_be_updated_by_owners(): void
    {
        $user = User::factory()->create();
    ...
    #[Test]
    public function teams_cannot_be_updated_by_members(): void
    {
    ...
    #[Test]
    public function teams_can_be_deleted_by_owners(): void
    {
        $user = User::factory()->create();
        $team = Team::factory()->create();
    ...
    #[Test]
    public function team_deletion_requires_name_confirmation(): void
    {
        $user = User::factory()->create();
        $team = Team::factory()->create();
    ...
    #[Test]
    public function deleting_current_team_switches_to_alphabetically_first_remaining_team(): void
    {
    ...
    #[Test]
    public function deleting_current_team_falls_back_to_personal_team_when_alphabetically_first(): void
    {
        $user = User::factory()->create();
    ...
    #[Test]
    public function deleting_non_current_team_leaves_current_team_unchanged(): void
    {
        $user = User::factory()->create();
        $personalTeam = $user->personalTeam();
        $team = Team::factory()->create();
    ...
    #[Test]
    public function deleting_team_switches_other_affected_users_to_their_personal_team(): void
    {
        $owner = User::factory()->create();
        $member = User::factory()->create();
    ...
    #[Test]
    public function personal_teams_cannot_be_deleted(): void
    {
        $user = User::factory()->create();
    ...
    #[Test]
    public function teams_cannot_be_deleted_by_non_owners(): void
    {
        $owner = User::factory()->create();
        $member = User::factory()->create();
        $team = Team::factory()->create();
    ...
    #[Test]
    public function users_can_switch_teams(): void
    {
        $user = User::factory()->create();
        $team = Team::factory()->create();
    ...
    #[Test]
    public function users_cannot_switch_to_team_they_dont_belong_to(): void
    {
        $user = User::factory()->create();
        $team = Team::factory()->create();
    ...
    #[Test]
    public function guests_cannot_access_teams(): void
    {
